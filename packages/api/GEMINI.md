...
Le `GEMINI.md` parent (`packages/bunlight/GEMINI.md`) couvre la mission Bunlight, les 5 profiles et les règles code (Bun-native, pas d'emoji). Ne pas dupliquer ici.
