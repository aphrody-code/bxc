...
export const JSONArraySchema: z.ZodType<JSONArray, JSONArray> =
	z.array(JSONValueSchema);
/**
...
const resultSchemas: Record<string, z.core.$ZodType> = {
	...
	"sampling/createMessage": z.union([
		CreateMessageResultWithToolsSchema,
		CreateTaskResultSchema,
	]),
 ...
 */
export function getResultSchema<M extends RequestMethod>(
	method: M,
): z.ZodType<ResultTypeMap[M]>;
export function getResultSchema(method: string): z.ZodType | undefined;
export function getResultSchema(method: string): z.ZodType | undefined {
	return resultSchemas[method as RequestMethod] as unknown as
		| z.ZodType
		| undefined;
}
...
type RequestSchemaType =
	| (typeof ClientRequestSchema.options)[number]
	| (typeof ServerRequestSchema.options)[number];
type NotificationSchemaType =
	| (typeof ClientNotificationSchema.options)[number]
	| (typeof ServerNotificationSchema.options)[number];
...
const requestSchemas = buildSchemaMap([
	...ClientRequestSchema.options,
	...ServerRequestSchema.options,
] as const) as Record<RequestMethod, RequestSchemaType>;
const notificationSchemas = buildSchemaMap([
	...ClientNotificationSchema.options,
	...ServerNotificationSchema.options,
] as const) as Record<NotificationMethod, NotificationSchemaType>;
...
export function getRequestSchema(method: string): z.ZodType | undefined {
	return requestSchemas[method as RequestMethod] as unknown as
		| z.ZodType
		| undefined;
}
 ...
 * @see getRequestSchema for explanation of the internal type assertion.
 */
export function getNotificationSchema<M extends NotificationMethod>(
	method: M,
): z.ZodType<NotificationTypeMap[M]>;
export function getNotificationSchema(method: string): z.ZodType | undefined;
export function getNotificationSchema(method: string): z.ZodType | undefined {
	return notificationSchemas[method as NotificationMethod] as unknown as
		| z.ZodType
		| undefined;
}
