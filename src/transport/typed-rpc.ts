 ...
 * path Bun-internal IPC we want a zero-runtime-cost typed envelope with
 * request / response / message packets and bidirectional handlers.
 */
...
>(options: _RPCAllOptions<Schema> = {}) {
	...
	let requestHandler: RPCRequestHandlerFn<Schema["requests"]> | undefined = undefined;
