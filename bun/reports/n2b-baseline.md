...
## `examples/challonge-api/dump-tournament.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 28:41 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
## `src/cli/challonge.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 23:53 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |

## `src/cli/chrome.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 7:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 23:41 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
## `src/db/BunlightDB.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 3:28 | `imports/node-prefix` | préfixer 'fs' avec 'node:' (recommandé) | `node:fs` | compat: 🟢 full (node:fs) |
| 2:26 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 48:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
| 376:27 | `imports/node-prefix` | préfixer 'zlib' avec 'node:' (recommandé) | `node:zlib` | compat: 🟢 full (node:zlib) |
| 244:55 | `api/fileURLToPath` | Bun.fileURLToPath() est équivalent (ou utiliser import.meta.dir/path) |  |  |

## `src/ffi/rust-bridge.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 2:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 42:76 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |

## `src/plugin/next-plugin.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 43:67 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 25:50 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
| 150:19 | `api/child-process-spawn` | Bun.spawn offre une API plus ergonomique (streams Web, ipc, preload) |  |  |

## `src/pool/AutoscaledPool.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 43:51 | `imports/node-prefix` | préfixer 'os' avec 'node:' (recommandé) | `node:os` | compat: 🟢 full (node:os) |

## `src/pool/SessionPool.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 31:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 28:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |

## `src/storage/Dataset.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 29:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |

## `src/storage/KeyValueStore.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 45:32 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 12:25 | `imports/node-prefix` | préfixer 'os' avec 'node:' (recommandé) | `node:os` | compat: 🟢 full (node:os) |
| 13:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 22:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |

## `test/integration/crawlee-patterns.test.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 12:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
| 13:25 | `imports/node-prefix` | préfixer 'os' avec 'node:' (recommandé) | `node:os` | compat: 🟢 full (node:os) |

## `test/integration/curl-impersonate.test.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 20:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 17:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
## `test/integration/har-roundtrip.test.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 17:25 | `imports/node-prefix` | préfixer 'os' avec 'node:' (recommandé) | `node:os` | compat: 🟢 full (node:os) |
| 18:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
## `test/integration/tracing.test.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 3:25 | `imports/node-prefix` | préfixer 'fs/promises' avec 'node:' (recommandé) | `node:fs/promises` | compat: 🟢 full (node:fs/promises) |
...
| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 33:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |
...
## `test/unit/har-recorder.test.ts`

| ligne | règle | message | remplacement | compat |
| --- | --- | --- | --- | --- |
| 19:25 | `imports/node-prefix` | préfixer 'os' avec 'node:' (recommandé) | `node:os` | compat: 🟢 full (node:os) |
| 20:23 | `imports/node-prefix` | préfixer 'path' avec 'node:' (recommandé) | `node:path` | compat: 🟢 full (node:path) |

## `test/unit/har-replayer.test.ts`
